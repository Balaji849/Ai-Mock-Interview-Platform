...
const interviewer = await getInterviewerProfile(id);
  ...
  {/* Foreground Content */}
  <div className="relative z-10 max-w-6xl mx-auto px-8 pt-20 pb-14 flex flex-col gap-8">
    <Link href="/explore">
      <Button variant="link" className="text-stone-500 cursor-pointer flex items-center  mt-3 ">
        <ArrowLeft size={13} />
        Back to explore
      </Button>
    </Link>
     ...
     <div className="flex items-start gap-8">
       <Avatar className="w-24 h-24 border-2 border-white/10 shrink-0 rounded-2xl">
            ...
            <div className="flex flex-col gap-3 min-w-0 pt-1">
               <h1 className=" text-[clamp(2rem,4vw,3rem)] leading-[1.05] tracking-tight">
              ...
              <div className="flex items-center gap-2 flex-wrap mt-1">
                ...
                <Badge
                  variant="outline"
                  className="border-purple-400/25 bg-purple-400/8 text-purple-400 text-xs px-3 py-1"
                >
            ...
            <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-5">
              ...
              <div className="flex flex-wrap gap-2.5">
                {interviewer.categories.map((cat) => (
                  <span
                    key={cat}
                    className="text-sm px-4 py-2 rounded-xl border border-purple-400/20 bg-purple-400/5 text-purple-400"
                  >
  ...
  <li key={title} className="flex items-start gap-4">
    <span className="mt-0.5 w-10 h-10 shrink-0 rounded-xl bg-purple-400/10 border border-purple-400/20 flex items-center justify-center">
