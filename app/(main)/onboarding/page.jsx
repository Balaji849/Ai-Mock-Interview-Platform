          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            {ONBOARDING_ROLES.map((r) => (
              <button
                ...
                className="text-left rounded-2xl p-8 border border-white/10 bg-[#0f0f11] hover:border-puple-400/20 hover:-translate-y-0.5 transition-all duration-300"
              >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between bg-[#0f0f11] border border-white/10 rounded-2xl px-6 py-4">
              <div className="flex items-center gap-3">
                <span className="w-9 h-9 rounded-xl bg-puple-400/10 border border-puple-400/20 flex items-center justify-center text-base shrink-0">
                    ...
                    <button
                      ...
                      className={`text-xs px-4 py-2 rounded-lg border ${
                        form.yearsExp === opt.value
                          ? "border-puple-400/40 bg-puple-400/10 text-puple-400"
