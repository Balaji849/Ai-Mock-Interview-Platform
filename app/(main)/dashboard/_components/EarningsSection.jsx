            ...
            {history.map((p) => (
              ...
              >
                ...
                <Badge
                  ...
                  className={
                    p.status === "PROCESSED" 
                      ? "border-green-500/20 bg-green-500/30 text-green-400 p-3"
                      : "border-purple-500/20 bg-purple-500/10 text-purple-400 p-3"
                  }
                >
            ...
            <>
              <DialogHeader>
                ...
                <DialogDescription className="text-stone-500 text-xs font-light">
                  ...
                  <span className="text-purple-400">{balance} credits</span> will
                  be withdrawn.
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="flex flex-col gap-5 py-2">
                ...
                <div className="rounded-xl bg-[#141417] border border-white/8 p-4 flex flex-col gap-2">
                  ...
                  <div className="flex justify-between text-sm font-medium">
                    ...
                    <span className="text-purple-400">${netAmount}</span>
                  </div>
                </div>
