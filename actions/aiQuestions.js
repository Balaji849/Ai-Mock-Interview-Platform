...
const CATEGORY_PROMPTS = {
  FRONTEND: "React, JavaScript, CSS, performance, accessibility, browser APIs, Shad CN ui, TailWind,",
  BACKEND:
    "Node.js, REST APIs, Java, Spring Boot, databases, authentication, caching, scalability",
  FULLSTACK:
